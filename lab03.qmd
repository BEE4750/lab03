...
At the lumber mill, wood can be turned into plywood of various grades (see the table for how much wood of each type is required for and the revenue from each grade).
...
Any excess wood is sent to be recycled into particle board, which can be sold for a net revenue of \$0.03 per bf. This is summarized in the figure below.
:::
...
Put the linear program into standard form. For an example of the syntax for this, see lines 82--91 [here](https://github.com/vsrikrish/environmental-systems-analysis/blob/Fall23/tutorials/julia-jump.qmd).
:::
...
Would you prefer to have 1,000 additional bf of spruce or 2,000 additional bf of fir?
:::
